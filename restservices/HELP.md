...
* The following dependencies are not known to work with Spring Native: 'Jersey, Eureka Server, Cloud Bootstrap'. As a
...
```
$ docker run --rm -p 8080:8080 assignment01:0.0.1-SNAPSHOT
```
